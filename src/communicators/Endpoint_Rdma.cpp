...
using gvirtus::communicators::Endpoint_Rdma;
using gvirtus::communicators::EndpointFactory;

Endpoint_Rdma::Endpoint_Rdma(const std::string &endp_suite,
...
Endpoint &Endpoint_Rdma::suite(const std::string &suite) {
...
Endpoint &Endpoint_Rdma::protocol(const std::string &protocol) {
...
Endpoint_Rdma &Endpoint_Rdma::address(const std::string &address) {
  std::regex pattern{
...
Endpoint_Rdma &Endpoint_Rdma::port(const std::string &port) {
  std::regex pattern{
